...
def initialize_chain():
    ...
    Instead, respond with: "I'm sorry, I can only provide information about Alejandro."
...
def main():
    ...
    """
    **Welcome to AOPT!**  
    I'm an AI-powered chatbot built using the Deep Seek model, designed to help you uncover detailed and reliable information about Alejandro Ortiz. Whether you're looking into his background, achievements, or insights into his work, I provide context-specific answers drawn from carefully curated data.
